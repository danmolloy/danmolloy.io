...
export default function Home() {
  ...
  return (
    <div className='main'>
      ...
      <h2 className='font-light'>I am a <span className='text-yellow-400 font-semibold'>{word}</span></h2>
      <div className='w-96 h-96 relative self-center mt-4'>
        <Image src='/images/portrait.jpeg' layout="fill" />
      </div>
    </div>
  )
}
